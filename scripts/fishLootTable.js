...
export const fishLootTable = {
    easy: {
        ...
        "Key West, Florida": [
            ...
            { grade: "B",  name: "Grouper", fishSize: 30, fishImage: "/images/fish/keywest/grouper.png" },
            { grade: "A",  name: "Cobbler", fishSize: 18, fishImage: "/images/fish/keywest/cobbler.png" },
    ...
    medium: {
        "Jeju Island (제주도)": [
            ...
            { grade: "B",  name: "Freshwater Eel", maxScore: 700 , fishSize: 6, fishImage: "/images/fish/jejuisland/freshwater_eel.png" },
            { grade: "A",  name: "Softshell Turtle", fishSize: 12, fishImage: "/images/fish/jejuisland/softshell.png" },
        ...
        "Yangtze River (长江)": [
            ...
            { grade: "B",  name: "Loach", fishSize: 0.5, fishImage: "/images/fish/yangtze/loach.png" },
            { grade: "A",  name: "Grass Carp", fishSize: 10, fishImage: "/images/fish/yangtze/grass_carp.png" },
        ...
        "Okinawa Islands (沖縄)": [
            ...
            { grade: "A",  name: "Amberjack", fishSize: 10, fishImage: "/images/fish/okinawa/amberjack.png" },
        ...
        "Taal Lake": [
            ...
            { grade: "B",  name: "lobed Silver Mullet", fishSize: 2, fishImage: "/images/fish/taal/lobed_mullet.png" },
            { grade: "A",  name: "Milkfish", fishSize: 5, fishImage: "/images/fish/taal/milkfish.png" },
    ...
    hard: {
        "Amazon River Basin": [
            { grade: "C",  name: "Neon Tetra", fishSize: 0.5, fishImage: "/images/fish/amazon/tetra.png" },
            { grade: "B",  name: "Piranha", maxScore: 700 , fishSize: 1, fishImage: "/images/fish/amazon/piranha.png" },
            { grade: "A",  name: "Electric Eel", fishSize: 15, fishImage: "/images/fish/amazon/electric_eel.png" },
            { grade: "S",  name: "Piraíba Catfish", fishSize: 90, fishImage: "/images/fish/amazon/piraiba_catfish.png" },
            { grade: "S+",  name: "Arapaima", fishSize: 150, fishImage: "/images/fish/amazon/arapaima.png" },
            {
                name: "Yacumama",
                fishSize: 5000,
                fishImage: "/images/fish/amazon/yacumama.png",
                isRare: true
            }
        ],

        "Rio Paraná": [
            { grade: "C",  name: "Cascudo Catfish", fishSize: 0.3, fishImage: "/images/fish/rio/cascudo.png" },
            { grade: "B",  name: "Dorado", fishSize: 25, fishImage: "/images/fish/rio/dorado.png" },
            { grade: "A",  name: "Pintado", fishSize: 80, fishImage: "/images/fish/rio/pintado.png" },
            { grade: "S",  name: "Surubí Catfish", fishSize: 100, fishImage: "/images/fish/rio/surubi.png" },
            { grade: "S+",  name: "Manguruyú", fishSize: 120, fishImage: "/images/fish/rio/manguruyu.png" },
            {
                name: "Plesiosaurus",
                fishSize: 10000,
                fishImage: "/images/fish/rio/plesiosaur.png",
                isRare: true
            }
        ],

        "Zambezi River": [
            { grade: "C",  name: "Banded Tilapia", fishSize: 0.3, fishImage: "/images/fish/zambezi/banded_tilapia.png" },
            { grade: "B",  name: "Bream", fishSize: 5, fishImage: "/images/fish/zambezi/bream.png" },
            { grade: "A",  name: "Tigerfish", fishSize: 10, fishImage: "/images/fish/zambezi/tigerfish.png" },
            { grade: "S",  name: "African Sharptooth Catfish", fishSize: 15, fishImage: "/images/fish/zambezi/sharptooth_catfish.png" },
            { grade: "S+",  name: "Nile Perch", fishSize: 1000, fishImage: "/images/fish/zambezi/nile_perch.png" },
            {
                name: "Nyami-Nyami",
                fishSize:200,
                fishImage: "/images/fish/zambezi/nyami.png",
                isRare: true
            }
        ],

        "Lake Victoria": [
            { grade: "C",  name: "African Bullfrog", fishSize: 1.5, fishImage: "/images/fish/victoria/bullfrog.png" },
            { grade: "B",  name: "Helmeted Turtle", fishSize: 2, fishImage: "/images/fish/victoria/helmet_turtle.png" },
            { grade: "A",  name: "Serrated Hinged Terrapin", fishSize: 5, fishImage: "/images/fish/victoria/terrapin.png" },
            { grade: "S",  name: "Softshell Turtle", fishSize: 40, fishImage: "/images/fish/victoria/softshell.png" },
            { grade: "S+",  name: "Nile Crocodile", fishSize: 250, fishImage: "/images/fish/victoria/croc.png" },
            {
                name: "Pixel Perch",
                fishSize: 30,
                fishImage: "/images/fish/victoria/pixel_perch.png",
                isRare: true
            }
        ],
    }
